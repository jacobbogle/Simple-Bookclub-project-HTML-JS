...
let laserSound = new Sound(
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/pew.m4a",
  5,
  0.4
);
let thrustSound = new Sound(
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/thrust.m4a"
);
let hitSound = new Sound(
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/hit.m4a",
  5,
  0.8
);
let explosionSound = new Sound(
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/explosion.m4a",
  1,
  0.7
);
...
//MUSIC
let music = new Music(
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/music-high.m4a",
  "https://margaux-dev.github.io/asteroids-game/asteroids-game-sounds/music-low.m4a"
);
...
function newAsteroid(x, y, r) {
  ...
  let roid = {
    ...
    y: y,
    xv:
      ((Math.random() * roidsSpeed * lvlMultiply) / FPS) *
      (Math.random() < 0.5 ? 1 : -1),
    yv:
      ((Math.random() * roidsSpeed * lvlMultiply) / FPS) *
      (Math.random() < 0.5 ? 1 : -1),
...
function soundToggle() {
  if (soundOn === false) {
    ...
    document.querySelector("#sound").innerHTML =
      '<i class="fas fa-volume-up" aria-hidden="true" aria-label="sound on"></i>';
  } else {
    soundOn = false;
    document.querySelector("#sound").innerHTML =
      '<i class="fas fa-volume-mute" aria-hidden="true" aria-label="sound off"></i>';
  }
}
